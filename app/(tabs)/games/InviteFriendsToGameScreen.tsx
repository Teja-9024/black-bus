// screens/InviteFriendsToGameScreen.tsx
...
import GameService from '@/services/GameService'; // Import the new GameService
...
export default function InviteFriendsToGameScreen() {
  ...
  const handleSendInvite = async () => {
    ...
    try {
      await GameService.sendGameInvite(accessToken, gameId, Array.from(selectedFriendIds));
            ...
            <>
              ...
              >
                <Feather
                  name="search"
                  size={20}
                  color={OVERLAY_DIM_TEXT_COLOR}
                  style={styles.searchIcon}
                />
                <TextInput
                  style={[styles.searchInput, { color: OVERLAY_PRIMARY_TEXT_COLOR }]}
                  placeholder="Search friends"
                  placeholderTextColor={OVERLAY_DIM_TEXT_COLOR}
                  value={searchQuery}
